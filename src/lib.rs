...
#[derive(Debug)]
pub struct SynthVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SynthVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SynthVault processing");
    
    let mut processor = SynthVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SynthVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SynthVaultProcessor::new(false);
